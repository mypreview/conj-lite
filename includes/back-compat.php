 ...
 */
if ( ! function_exists( 'conjws_lite_switch_theme' ) ):
	function conjws_lite_switch_theme() {

		switch_theme( WP_DEFAULT_THEME, WP_DEFAULT_THEME );
		unset( $_GET['activated'] );
		add_action( 'admin_notices', 'conjws_lite_upgrade_notice', 10 );

	}
endif;
add_action( 'after_switch_theme', 'conjws_lite_switch_theme', 10 );
/**
 ...
 */
if ( ! function_exists( 'conjws_lite_upgrade_notice' ) ):
	function conjws_lite_upgrade_notice() {
 ...
 * @global string $wp_version WordPress version.
 */
if ( ! function_exists( 'conjws_lite_customize' ) ):
	function conjws_lite_customize() {
...
add_action( 'load-customize.php', 'conjws_lite_customize', 10 );
/**
 * Prevents the Theme Preview from being loaded on WordPress versions prior to 4.8.
 * @global string $wp_version WordPress version.
 */
if ( ! function_exists( 'conjws_lite_preview' ) ):
	function conjws_lite_preview() {
...
add_action( 'template_redirect', 'conjws_lite_preview', 10 );